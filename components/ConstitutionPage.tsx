...
export function ConstitutionPage() {
  ...
  return (
    <div className="space-y-8 min-w-0 w-full max-w-full overflow-visible">
      <div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 border border-gray-200 dark:border-gray-700 min-w-0 overflow-visible">
        ...
        <div className="space-y-4 min-w-0 overflow-visible">
          <div className="flex flex-wrap justify-between items-center py-3 border-b border-gray-200 dark:border-gray-700 gap-y-1">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 border border-gray-200 dark:border-gray-700 min-w-0 overflow-visible">
        ...
        <div className="space-y-4 min-w-0 overflow-visible">
          <div className="flex flex-wrap justify-between items-center py-3 border-b border-gray-200 dark:border-gray-700 gap-y-1 min-w-0">
          ...
          <div className="py-3 min-w-0 overflow-visible">
            <div className="flex items-center gap-2 mb-3 min-w-0 overflow-visible">
                      ...
                      <div className="min-w-0 overflow-hidden">
                        <div className="flex items-center gap-2 mb-1 min-w-0">
                          ...
                          <div className="relative group flex-shrink-0" tabIndex={0} data-tooltip-anchor>
                            ...
                            <div data-tooltip className="absolute bottom-full mb-2 left-0 w-[80vw] sm:w-56 max-w-[calc(100vw-2rem)] p-2 bg-gray-900 dark:bg-gray-800 text-white text-xs rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible group-focus-within:opacity-100 group-focus-within:visible transition-all duration-200 z-10 border border-gray-700">
